...
pub struct SelendraRuntimeExecutor;

impl sc_executor::NativeExecutionDispatch for SelendraRuntimeExecutor {
	...
	let rpc_extensions_builder = {
		...
		Box::new(move |deny_unsafe, subscription| {
			let deps = crate::rpc::FullDeps {
				...
				transaction_converter: selendra_runtime::TransactionConverter,
...
pub async fn start_parachain_node(
	...
	TaskManager,
	Arc<TFullClient<Block, RuntimeApi, NativeElseWasmExecutor<SelendraRuntimeExecutor>>>,
)> {
	start_node_impl::<RuntimeApi, SelendraRuntimeExecutor, _, _>(
        parachain_config,
        polkadot_config,
        id,
        build_import_queue,
